  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        // Segmented control: the active segment lifts one tone and takes
        // full-strength text, no shadow.
        "data-active:bg-accent data-active:text-foreground",
        // Underline used by the `line` variant — brand yellow marks position.
