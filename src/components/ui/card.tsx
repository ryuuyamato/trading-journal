...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // Flat panel: a solid 1px border instead of a ring/shadow, so surfaces
        // stack by tone rather than by float.
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-lg border-t bg-secondary/50 p-(--card-spacing)",
        className
      )}
      {...props}
    />
